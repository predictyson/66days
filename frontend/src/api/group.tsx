...
async function fetchGroupPageData(id: number) {
  try {
...
async function fetchAppliedMembers(id: number) {
  try {
...
async function fetchGroupBadges(id: number) {
  try {
...
async function fetchBoardListByPage(groupId: number, page: number) {
  try {
